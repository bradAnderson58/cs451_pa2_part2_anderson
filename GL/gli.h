...
class gli {
    ...
    typedef bool (* GLI_MOTION_FUNC)  ( int x, int y );
...
public:
	...
	static float bradAzimFunc() { return m_currentAzim + m_deltaAzim; }		//This is neccessary for mouse translation!
	static float bradElevFunc() { return m_currentElev + m_deltaElev; }
